...
public class HiveConf extends Configuration {
    ...
    @InterfaceAudience.Private public static final String PREFIX_LLAP = "llap.";
    @InterfaceAudience.Private public static final String PREFIX_HIVE_LLAP = "hive.llap.";
    ...
    public static final ConfVars[] metaVars = {
        ...
        ConfVars.METASTORE_SERVER_PORT,
        ConfVars.METASTORETHRIFTCONNECTIONRETRIES,
        ConfVars.METASTORETHRIFTFAILURERETRIES,
        ConfVars.METASTORE_CLIENT_CONNECT_RETRY_DELAY,
        ConfVars.METASTORE_CLIENT_SOCKET_TIMEOUT,
        ConfVars.METASTORE_CLIENT_SOCKET_LIFETIME,
        ConfVars.METASTOREPWD,
        ConfVars.METASTORECONNECTURLHOOK,
        ConfVars.METASTORECONNECTURLKEY,
        ConfVars.METASTORESERVERMINTHREADS,
        ConfVars.METASTORESERVERMAXTHREADS,
        ConfVars.METASTORE_TCP_KEEP_ALIVE,
        ConfVars.METASTORE_INT_ORIGINAL,
        ConfVars.METASTORE_INT_ARCHIVED,
        ConfVars.METASTORE_INT_EXTRACTED,
        ConfVars.METASTORE_KERBEROS_KEYTAB_FILE,
        ConfVars.METASTORE_KERBEROS_PRINCIPAL,
        ConfVars.METASTORE_USE_THRIFT_SASL,
        ConfVars.METASTORE_TOKEN_SIGNATURE,
        ConfVars.METASTORE_CACHE_PINOBJTYPES,
        ConfVars.METASTORE_CONNECTION_POOLING_TYPE,
        ...
        ConfVars.METASTORE_AUTO_CREATE_ALL,
        ...
        ConfVars.METASTORE_AUTHORIZATION_STORAGE_AUTH_CHECKS,
        ConfVars.METASTORE_BATCH_RETRIEVE_MAX,
        ConfVars.METASTORE_EVENT_LISTENERS,
        ConfVars.METASTORE_TRANSACTIONAL_EVENT_LISTENERS,
        ConfVars.METASTORE_EVENT_CLEAN_FREQ,
        ConfVars.METASTORE_EVENT_EXPIRY_DURATION,
        ConfVars.METASTORE_EVENT_MESSAGE_FACTORY,
        ConfVars.METASTORE_FILTER_HOOK,
        ConfVars.METASTORE_RAW_STORE_IMPL,
        ConfVars.METASTORE_END_FUNCTION_LISTENERS,
        ConfVars.METASTORE_PART_INHERIT_TBL_PROPS,
        ConfVars.METASTORE_BATCH_RETRIEVE_OBJECTS_MAX,
        ConfVars.METASTORE_INIT_HOOKS,
        ConfVars.METASTORE_PRE_EVENT_LISTENERS,
        ConfVars.HMSHANDLERATTEMPTS,
        ConfVars.HMSHANDLERINTERVAL,
        ConfVars.HMSHANDLERFORCERELOADCONF,
        ConfVars.METASTORE_PARTITION_NAME_WHITELIST_PATTERN,
        ...
        ConfVars.HIVE_TXN_TIMEOUT,
        ConfVars.HIVE_TXN_OPERATIONAL_PROPERTIES,
        ConfVars.HIVE_TXN_HEARTBEAT_THREADPOOL_SIZE,
        ConfVars.HIVE_TXN_MAX_OPEN_BATCH,
        ConfVars.HIVE_TXN_RETRYABLE_SQLEX_REGEX,
        ConfVars.HIVE_METASTORE_STATS_NDV_TUNER,
        ConfVars.HIVE_METASTORE_STATS_NDV_DENSITY_FUNCTION,
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_ENABLED,
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_SIZE,
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_MAX_PARTITIONS,
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_FPP,
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_MAX_VARIANCE,
        ...
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_MAX_FULL,
        ConfVars.METASTORE_AGGREGATE_STATS_CACHE_CLEAN_UNTIL,
        ConfVars.METASTORE_FASTPATH,
        ConfVars.METASTORE_HBASE_CATALOG_CACHE_SIZE,
        ConfVars.METASTORE_HBASE_AGGREGATE_STATS_CACHE_SIZE,
        ConfVars.METASTORE_HBASE_AGGREGATE_STATS_CACHE_MAX_PARTITIONS,
        ConfVars.METASTORE_HBASE_AGGREGATE_STATS_CACHE_FALSE_POSITIVE_PROBABILITY,
        ConfVars.METASTORE_HBASE_AGGREGATE_STATS_CACHE_MAX_VARIANCE,
        ConfVars.METASTORE_HBASE_CACHE_TIME_TO_LIVE,
        ConfVars.METASTORE_HBASE_CACHE_MAX_WRITER_WAIT,
        ConfVars.METASTORE_HBASE_CACHE_MAX_READER_WAIT,
        ConfVars.METASTORE_HBASE_CACHE_MAX_FULL,
        ConfVars.METASTORE_HBASE_CACHE_CLEAN_UNTIL,
        ConfVars.METASTORE_HBASE_CONNECTION_CLASS,
        ConfVars.METASTORE_HBASE_AGGR_STATS_CACHE_ENTRIES,
        ConfVars.METASTORE_HBASE_AGGR_STATS_MEMORY_TTL,
        ConfVars.METASTORE_HBASE_AGGR_STATS_INVALIDATOR_FREQUENCY,
        ConfVars.METASTORE_HBASE_AGGR_STATS_HBASE_TTL,
        ConfVars.METASTORE_HBASE_FILE_METADATA_THREADS
    };
    ...
    /**
     * dbVars are the parameters can be set per database. If these parameters are set as a database
     * property, when switching to that database, the HiveConf variable will be changed. The change
     * of these parameters will effectively change the DFS and MapReduce clusters for different
     * databases.
     */
    public static final ConfVars[] dbVars = {
        ConfVars.HADOOPBIN, ConfVars.METASTOREWAREHOUSE, ConfVars.SCRATCHDIR
    };

    /**
     * Variables used by LLAP daemons. TODO: Eventually auto-populate this based on prefixes. The
     * conf variables will need to be renamed for this.
     */
    ...
    private static void populateLlapDaemonVarsSet(Set<String> llapDaemonVarsSetLocal) {
        ...
        llapDaemonVarsSetLocal.add(
                ConfVars.LLAP_DAEMON_AM_LIVENESS_CONNECTION_SLEEP_BETWEEN_RETRIES_MS.varname);
     ...
     * ConfVars.
     *
     * <p>These are the default configuration properties for Hive. Each HiveConf object is
     * initialized as follows:
     *
     * <p>1) Hadoop configuration properties are applied. 2) ConfVar properties with non-null values
     * are overlayed. 3) hive-site.xml properties are overlayed.
     *
     * <p>WARNING: think twice before adding any Hadoop configuration properties with non-null
     * values to this list as they will override any values defined in the underlying Hadoop
     * configuration.
     */
    public static enum ConfVars {
        ...
        DYNAMICPARTITIONMAXPARTS(
                "hive.exec.max.dynamic.partitions",
                1000,
                "Maximum number of dynamic partitions allowed to be created in total."),
        DYNAMICPARTITIONMAXPARTSPERNODE(
        ...
        HIVE_IN_TEZ_TEST(
                "hive.in.tez.test", false, "internal use only, true when in testing tez", true),
        ...
        METASTORE_HBASE_CATALOG_CACHE_SIZE(
        ...
        METASTORE_HBASE_AGGREGATE_STATS_CACHE_SIZE(
        ...
        METASTORE_HBASE_AGGREGATE_STATS_CACHE_MAX_PARTITIONS(
                "hive.metastore.hbase.aggregate.stats.max.partitions",
                10000,
                "Maximum number of partitions that are aggregated per cache node."),
        METASTORE_HBASE_AGGREGATE_STATS_CACHE_FALSE_POSITIVE_PROBABILITY(
        ...
        METASTORE_HBASE_AGGREGATE_STATS_CACHE_MAX_VARIANCE(
        ...
        METASTORE_HBASE_CACHE_MAX_READER_WAIT(
        ...
        METASTORE_HBASE_AGGR_STATS_HBASE_TTL(
        ...
        METASTORE_CONNECTION_POOLING_TYPE(
                ...
                "BONECP",
                new StringSet("BONECP", "DBCP", "HikariCP", "NONE"),
                "Specify connection pool library for datanucleus"),
        METASTORE_CONNECTION_POOLING_MAX_CONNECTIONS(
        ...
        METASTORE_SCHEMA_VERIFICATION_RECORD_VERSION(
        ...
        METASTORE_USE_LEGACY_VALUE_STRATEGY(
        ...
        METASTORE_TRANSACTIONAL_EVENT_LISTENERS(
        ...
        METASTORE_AUTHORIZATION_STORAGE_AUTH_CHECKS(
                ...
                "Should the metastore do authorization checks against the underlying storage (usually hdfs) \n"
                        ...
                        + "on the storage)."),
        METASTORE_AUTHORIZATION_EXTERNALTABLE_DROP_CHECK(
        ...
        METASTORE_INTEGER_JDO_PUSHDOWN(
        ...
        METASTORE_DIRECT_SQL_MAX_QUERY_LENGTH(
                "hive.direct.sql.max.query.length",
                100,
                "The maximum\n" + " size of a query string (in KB)."),
        METASTORE_DIRECT_SQL_MAX_ELEMENTS_IN_CLAUSE(
        ...
        METASTORE_LIMIT_PARTITION_REQUEST(
        ...
        METASTORE_EXPRESSION_PROXY_CLASS(
                "hive.metastore.expression.proxy",
                "org.apache.hadoop.hive.ql.optimizer.ppr.PartitionExpressionForMetastore",
                ""),
        METASTORE_DETACH_ALL_ON_COMMIT(
                "javax.jdo.option.DetachAllOnCommit",
                true,
                "Detaches all objects from session so that they can be used after transaction is committed"),
        METASTORE_NON_TRANSACTIONAL_READ(
                "javax.jdo.option.NonTransactionalRead", true, "Reads outside of transactions"),
        ...
        METASTORE_CLIENT_DROP_PARTITIONS_WITH_EXPRESSIONS(
        ...
        METASTORE_AGGREGATE_STATS_CACHE_MAX_PARTITIONS(
                "hive.metastore.aggregate.stats.cache.max.partitions",
                10000,
                "Maximum number of partitions that are aggregated per cache node."),
        METASTORE_AGGREGATE_STATS_CACHE_FPP(
                "hive.metastore.aggregate.stats.cache.fpp",
                (float) 0.01,
                "Maximum false positive probability for the Bloom Filter used in each aggregate stats cache node (default 1%)."),
        METASTORE_AGGREGATE_STATS_CACHE_MAX_VARIANCE(
        ...
        METASTORE_AGGREGATE_STATS_CACHE_TTL(
                "hive.metastore.aggregate.stats.cache.ttl",
                "600s",
                new TimeValidator(TimeUnit.SECONDS),
                "Number of seconds for a cached node to be active in the cache before they become stale."),
        METASTORE_AGGREGATE_STATS_CACHE_MAX_WRITER_WAIT(
        ...
        METASTORE_AGGREGATE_STATS_CACHE_CLEAN_UNTIL(
                ...
                "The cleaner thread cleans until cache reaches this % full size."),
        METASTORE_METRICS(
                "hive.metastore.metrics.enabled", false, "Enable metrics on the metastore."),
        METASTORE_INIT_METADATA_COUNT_ENABLED(
        ...
        HIVE_METASTORE_USE_SSL(
                "hive.metastore.use.SSL",
                false,
                "Set this to true for using SSL encryption in HMS server."),
        HIVE_METASTORE_SSL_KEYSTORE_PATH(
                "hive.metastore.keystore.path", "", "Metastore SSL certificate keystore location."),
        HIVE_METASTORE_SSL_KEYSTORE_PASSWORD(
                "hive.metastore.keystore.password",
                "",
                "Metastore SSL certificate keystore password."),
        HIVE_METASTORE_SSL_TRUSTSTORE_PATH(
                "hive.metastore.truststore.path",
                "",
                "Metastore SSL certificate truststore location."),
        HIVE_METASTORE_SSL_TRUSTSTORE_PASSWORD(
        ...
        MOVE_EXPORTED_METADATA_TO_TRASH(
        ...
        HIVE_CURRENT_DATABASE(
                "hive.current.database",
                "",
                "Database name used by current session. Internal usage only.",
                true),

        // for hive script operator
        HIVES_AUTO_PROGRESS_TIMEOUT(
                "hive.auto.progress.timeout",
                "0s",
                new TimeValidator(TimeUnit.SECONDS),
                "How long to run autoprogressor for the script/UDTF operators.\n"
                        + "Set to 0 for forever."),
        HIVESCRIPTAUTOPROGRESS(
        ...
        HIVE_STRICT_CHECKS_LARGE_QUERY(
        ...
        @Deprecated
        HIVEMAPREDMODE(
                "hive.mapred.mode", null, "Deprecated; use hive.strict.checks.* settings instead."),
        HIVEALIAS("hive.alias", "", ""),
        HIVEMAPSIDEAGGREGATE(
                "hive.map.aggr",
                true,
        ...
        HIVE_CBO_CNF_NODES_LIMIT(
                "hive.cbo.cnf.maxnodes",
                -1,
                "When converting to conjunctive normal form (CNF), fail if"
        ...
        HIVE_CBO_EXTENDED_COST_MODEL(
                "hive.cbo.costmodel.extended",
                false,
                "Flag to control enabling the extended cost model based on"
                        + "CPU, IO and cardinality. Otherwise, the cost model is based on cardinality."),
        HIVE_CBO_COST_MODEL_CPU(
                "hive.cbo.costmodel.cpu", "0.000001", "Default cost of a comparison"),
        HIVE_CBO_COST_MODEL_NET(
                "hive.cbo.costmodel.network",
                "150.0",
                "Default cost of a transfering a byte over network;"
                        + " expressed as multiple of CPU cost"),
        HIVE_CBO_COST_MODEL_LFS_WRITE(
                "hive.cbo.costmodel.local.fs.write",
                "4.0",
                "Default cost of writing a byte to local FS;"
                        + " expressed as multiple of NETWORK cost"),
        HIVE_CBO_COST_MODEL_LFS_READ(
                "hive.cbo.costmodel.local.fs.read",
                "4.0",
                "Default cost of reading a byte from local FS;"
                        + " expressed as multiple of NETWORK cost"),
        HIVE_CBO_COST_MODEL_HDFS_WRITE(
                "hive.cbo.costmodel.hdfs.write",
                "10.0",
                "Default cost of writing a byte to HDFS;"
                        + " expressed as multiple of Local FS write cost"),
        HIVE_CBO_COST_MODEL_HDFS_READ(
                "hive.cbo.costmodel.hdfs.read",
                "1.5",
                "Default cost of reading a byte from HDFS;"
                        + " expressed as multiple of Local FS read cost"),
        HIVE_CBO_SHOW_WARNINGS(
        ...
        HIVEMAPAGGRMEMORYTHRESHOLD(
                "hive.map.aggr.hash.force.flush.memory.threshold",
                (float) 0.9,
                "The max memory to be used by map-side group aggregation hash table.\n"
                        + "If the memory usage is higher than this number, force to flush data"),
        HIVEMAPAGGRHASHMINREDUCTION(
                "hive.map.aggr.hash.min.reduction",
                (float) 0.5,
                "Hash aggregation will be turned off if the ratio between hash  table size and input rows is bigger than this number. \n"
                        + "Set to 1 to make sure hash aggregation is never turned off."),
        HIVEMULTIGROUPBYSINGLEREDUCER(
        ...
        @Deprecated
        HIVE_GROUPBY_ORDERBY_POSITION_ALIAS(
                "hive.groupby.orderby.position.alias",
                false,
                "Whether to enable using Column Position Alias in Group By or Order By (deprecated).\n"
                        + "Use "
                        + HIVE_ORDERBY_POSITION_ALIAS.varname
                        + " or "
                        + HIVE_GROUPBY_POSITION_ALIAS.varname
                        + " instead"),
        HIVE_NEW_JOB_GROUPING_SET_CARDINALITY(
        ...
        HIVE_EXEC_COPYFILE_MAXNUMFILES(
        ...
        HIVEDEFAULTFILEFORMAT(
                ...
                "TextFile",
                new StringSet("TextFile", "SequenceFile", "RCfile", "ORC", "parquet"),
                "Default file format for CREATE TABLE statement. Users can explicitly override it by CREATE TABLE ... STORED AS [FORMAT]"),
        HIVEDEFAULTMANAGEDFILEFORMAT(
        ...
        HIVEQUERYRESULTFILEFORMAT(
                ...
                "SequenceFile",
                new StringSet("TextFile", "SequenceFile", "RCfile", "Llap"),
        ...
        HIVE_LOG_INCREMENTAL_PLAN_PROGRESS_INTERVAL(
        ...
        HIVESMALLTABLESFILESIZE(
                "hive.mapjoin.smalltable.filesize",
                25000000L,
                "The threshold for the input file size of the small tables; if the file size is smaller \n"
                        + "than this threshold, it will try to convert the common join into map join"),

        HIVE_SCHEMA_EVOLUTION(
        ...
        HIVE_TRANSACTIONAL_TABLE_SCAN(
                "hive.transactional.table.scan",
                false,
                "internal usage only -- do transaction (ACID) table scan.",
                true),

        HIVE_TRANSACTIONAL_NUM_EVENTS_IN_MEMORY(
        ...
        HIVETESTMODENOSAMPLE(
                ...
                false),
        HIVETESTMODEDUMMYSTATAGGR(
                "hive.test.dummystats.aggregator", "", "internal variable for test", false),
        HIVETESTMODEDUMMYSTATPUB(
                "hive.test.dummystats.publisher", "", "internal variable for test", false),
        HIVETESTCURRENTTIMESTAMP(
                "hive.test.currenttimestamp", null, "current timestamp for test", false),
        HIVETESTMODEROLLBACKTXN(
                "hive.test.rollbacktxn",
                false,
                "For testing only.  Will mark every ACID transaction aborted",
                false),
        HIVETESTMODEFAILCOMPACTION(
                "hive.test.fail.compaction",
                false,
                "For testing only.  Will cause CompactorMR to fail.",
                false),
        HIVETESTMODEFAILHEARTBEATER(
        ...
        HIVEMERGETEZFILES(
                "hive.merge.tezfiles", false, "Merge small files at the end of a Tez DAG"),
        HIVEMERGESPARKFILES(
                "hive.merge.sparkfiles",
                false,
                "Merge small files at the end of a Spark DAG Transformation"),
        HIVEMERGEMAPFILESSIZE(
                "hive.merge.size.per.task",
                (long) (256 * 1000 * 1000),
                "Size of merged files at the end of the job"),
        HIVEMERGEMAPFILESAVGSIZE(
        ...
        HIVE_PARQUET_TIMESTAMP_SKIP_CONVERSION(
        ...
        HIVE_INT_TIMESTAMP_CONVERSION_IN_SECONDS(
        ...
        HIVE_ORC_INCLUDE_FILE_FOOTER_IN_SPLITS(
                "hive.orc.splits.include.file.footer",
                false,
                "If turned on splits generated by orc will include metadata about the stripes in the file. This\n"
                        + "data is read remotely (from the client or HS2 machine) and sent to all the tasks."),
        HIVE_ORC_SPLIT_DIRECTORY_BATCH_MS(
        ...
        HIVE_IO_SARG_CACHE_MAX_WEIGHT_MB(
        ...
        HIVE_LAZYSIMPLE_EXTENDED_BOOLEAN_LITERAL(
        ...
        HIVECONVERTJOINNOCONDITIONALTASK(
        ...
        @Deprecated
        HIVELIMITTABLESCANPARTITION(
                "hive.limit.query.max.table.partition",
                -1,
                "This controls how many partitions can be scanned for each partitioned table.\n"
                        + "The default value \"-1\" means no limit. (DEPRECATED: Please use "
                        + ConfVars.METASTORE_LIMIT_PARTITION_REQUEST
                        + " in the metastore instead.)"),

        HIVECONVERTJOINMAXENTRIESHASHTABLE(
        ...
        HIVEHASHTABLEKEYCOUNTADJUSTMENT(
        ...
        HIVE_AUTO_SORTMERGE_JOIN_REDUCE(
        ...
        HIVEROWOFFSET(
                "hive.exec.rowoffset", false, "Whether to provide the row offset virtual column"),

        // Optimizer
        HIVEOPTINDEXFILTER(
                "hive.optimize.index.filter", false, "Whether to enable automatic use of indexes"),
        HIVEINDEXAUTOUPDATE(
        ...
        HIVEOPTSORTMERGEBUCKETMAPJOIN(
                "hive.optimize.bucketmapjoin.sortedmerge",
                false,
                "Whether to try sorted bucket merge map join"),
        HIVEOPTREDUCEDEDUPLICATION(
        ...
        HIVEOPTREDUCEDEDUPLICATIONMINREDUCER(
        ...
        HIVE_OPTIMIZE_LIMIT_TRANSPOSE_REDUCTION_PERCENTAGE(
        ...
        HIVE_OPTIMIZE_LIMIT_TRANSPOSE_REDUCTION_TUPLES(
        ...
        HIVE_OPTIMIZE_REDUCE_WITH_STATS(
        ...
        // CTE
        HIVE_CTE_MATERIALIZE_THRESHOLD(
        ...
        // Indexes
        HIVEOPTINDEXFILTER_COMPACT_MINSIZE(
        ...
        HIVEOPTINDEXFILTER_COMPACT_MAXSIZE(
        ...
        HIVE_INDEX_COMPACT_QUERY_MAX_ENTRIES(
        ...
        HIVE_INDEX_COMPACT_QUERY_MAX_SIZE(
        ...
        HIVE_INDEX_COMPACT_BINARY_SEARCH(
        ...
        HIVE_STATS_COLLECT_PART_LEVEL_STATS(
        ...
        HIVE_METASTORE_STATS_NDV_TUNER(
        ...
        HIVE_METASTORE_STATS_NDV_DENSITY_FUNCTION(
        ...
        HIVE_STATS_MAX_VARIABLE_LENGTH(
        ...
        HIVE_STATS_FETCH_PARTITION_STATS(
        ...
        // size
        // than the actual uncompressed/raw data size. This factor will be multiplied to file size
        // to estimate
        // the raw data size.
        HIVE_STATS_DESERIALIZATION_FACTOR(
        ...
        HIVE_TXN_RETRYABLE_SQLEX_REGEX(
        ...
        COMPACTOR_MAX_NUM_DELTA(
                "hive.compactor.max.num.delta",
                500,
                "Maximum number of delta files that "
        ...
        COMPACTOR_INITIATOR_FAILED_THRESHOLD(
                ...
                "Number of consecutive compaction failures (per table/partition) "
        ...
        HIVE_COMPACTOR_CLEANER_RUN_INTERVAL(
        ...
        HIVE_DRUID_INDEXING_GRANULARITY(
        ...
        HIVE_DRUID_NUM_HTTP_CONNECTION(
                "hive.druid.http.numConnection",
                20,
                "Number of connections used by\n" + "the HTTP client."),
        HIVE_DRUID_HTTP_READ_TIMEOUT(
        ...
        HIVE_DRUID_BASE_PERSIST_DIRECTORY(
        ...
        HIVE_DRUID_MAX_TRIES(
                "hive.druid.maxTries", 5, "Maximum number of retries before giving up"),
        HIVE_DRUID_PASSIVE_WAIT_TIME(
                "hive.druid.passiveWaitTimeMs", 30000, "Wait time in ms default to 30 seconds."),
        // For HBase storage handler
        HIVE_HBASE_WAL_ENABLED(
        ...
        HIVE_HBASE_SNAPSHOT_NAME(
                "hive.hbase.snapshot.name", null, "The HBase table snapshot name to use."),
        ...
        // For har files
        HIVEARCHIVEENABLED(
                "hive.archive.enabled", false, "Whether archiving operations are permitted"),

        HIVEOPTGBYUSINGINDEX(
        ...
        HIVEFETCHTASKCONVERSION(
                ...
                "more",
                new StringSet("none", "minimal", "more"),
        ...
        HIVEFETCHTASKCONVERSIONTHRESHOLD(
        ...
        HIVE_METASTORE_AUTHORIZATION_AUTH_READS(
        ...
        HIVE_AUTHORIZATION_TASK_FACTORY(
        ...
        HIVE_CLI_PRINT_HEADER(
                "hive.cli.print.header",
                false,
                "Whether to print the names of the columns in query output."),

        HIVE_CLI_TEZ_SESSION_ASYNC(
        ...
        // temporary variable for testing. This is added just to turn off this feature in case of a
        // bug in
        // deployment. It has not been documented in hive-default.xml intentionally, this should be
        // removed
        // once the feature is stable
        HIVE_EXIM_RESTRICT_IMPORTS_INTO_REPLICATED_TABLES(
        ...
        HIVE_METRICS_JSON_FILE_LOCATION(
        ...
        HIVE_METRICS_JSON_FILE_INTERVAL(
        ...
        HIVE_METRICS_HADOOP2_COMPONENT_NAME(
        ...
        HIVE_INSERT_INTO_EXTERNAL_TABLES(
        ...
        HIVE_TEMPORARY_TABLE_STORAGE(
                ...
                "default",
                new StringSet("memory", "ssd", "default"),
                "Define the storage policy for temporary tables."
        ...
        HIVE_SERVER2_ZOOKEEPER_PUBLISH_CONFIGS(
        ...
        HIVE_SERVER2_GLOBAL_INIT_FILE_LOCATION(
        ...
        HIVE_SERVER2_TRANSPORT_MODE(
                ...
                "binary",
                new StringSet("binary", "http"),
                "Transport mode of HiveServer2."),
        HIVE_SERVER2_THRIFT_BIND_HOST(
                "hive.server2.thrift.bind.host",
                "",
                "Bind host on which to run the HiveServer2 Thrift service."),
        HIVE_SERVER2_PARALLEL_COMPILATION(
        ...
        HIVE_SERVER2_COMPILE_LOCK_TIMEOUT(
        ...
        HIVE_SERVER2_PARALLEL_OPS_IN_SESSION(
        ...
        HIVE_SERVER2_WEBUI_SPNEGO_KEYTAB(
        ...
        HIVE_SERVER2_WEBUI_SPNEGO_PRINCIPAL(
        ...
        HIVE_SERVER2_WEBUI_MAX_HISTORIC_QUERIES(
        ...
        HIVE_SERVER2_TEZ_SESSIONS_PER_DEFAULT_QUEUE(
                "hive.server2.tez.sessions.per.default.queue",
                1,
                "A positive integer that determines the number of Tez sessions that should be\n"
                        + "launched on each of the queues specified by \"hive.server2.tez.default.queues\".\n"
                        + "Determines the parallelism on each queue."),
        HIVE_SERVER2_TEZ_INITIALIZE_DEFAULT_SESSIONS(
                "hive.server2.tez.initialize.default.sessions",
                false,
                "This flag is used in HiveServer2 to enable a user to use HiveServer2 without\n"
                        + "turning on Tez for HiveServer2. The user could potentially want to run queries\n"
                        + "over Tez without the pool of sessions."),
        HIVE_SERVER2_TEZ_SESSION_LIFETIME(
        ...
        HIVE_SERVER2_TEZ_SESSION_LIFETIME_JITTER(
        ...
        HIVE_SERVER2_TEZ_SESSION_MAX_INIT_THREADS(
        ...
        HIVE_SERVER2_TEZ_SESSION_RESTRICTED_CONFIGS(
        ...
        HIVE_SERVER2_TEZ_SESSION_CUSTOM_QUEUE_ALLOWED(
                "hive.server2.tez.sessions.custom.queue.allowed",
                "true",
                new StringSet("true", "false", "ignore"),
        ...
        HIVE_SERVER2_METRICS_ENABLED(
                "hive.server2.metrics.enabled", false, "Enable metrics on the HiveServer2."),
        ...
        HIVE_SERVER2_THRIFT_HTTP_REQUEST_HEADER_SIZE(
        ...
        HIVE_SERVER2_THRIFT_HTTP_RESPONSE_HEADER_SIZE(
        ...
        HIVE_SERVER2_THRIFT_HTTP_COOKIE_AUTH_ENABLED(
        ...
        HIVE_SERVER2_THRIFT_HTTP_COOKIE_IS_HTTPONLY(
        ...
        HIVE_SERVER2_THRIFT_MAX_WORKER_THREADS(
        ...
        HIVE_SERVER2_THRIFT_LOGIN_TIMEOUT(
        ...
        HIVE_SERVER2_ASYNC_EXEC_WAIT_QUEUE_SIZE(
        ...
        HIVE_SERVER2_ASYNC_EXEC_ASYNC_COMPILE(
        ...
        HIVE_SERVER2_LONG_POLLING_TIMEOUT(
        ...
        HIVE_SERVER2_PLAIN_LDAP_BASEDN(
                "hive.server2.authentication.ldap.baseDN", null, "LDAP base DN"),
        HIVE_SERVER2_PLAIN_LDAP_DOMAIN("hive.server2.authentication.ldap.Domain", null, ""),
        HIVE_SERVER2_PLAIN_LDAP_GROUPDNPATTERN(
        ...
        HIVE_SERVER2_PLAIN_LDAP_GROUPFILTER(
        ...
        HIVE_SERVER2_PLAIN_LDAP_USERDNPATTERN(
        ...
        HIVE_SERVER2_PLAIN_LDAP_USERFILTER(
        ...
        HIVE_SERVER2_PLAIN_LDAP_GUIDKEY(
        ...
        HIVE_SERVER2_PLAIN_LDAP_GROUPCLASS_KEY(
        ...
        HIVE_SERVER2_PLAIN_LDAP_CUSTOMLDAPQUERY(
        ...
        HIVE_SERVER2_BUILTIN_UDF_WHITELIST(
        ...
        HIVE_SERVER2_CLOSE_SESSION_ON_DISCONNECT(
        ...
        HIVE_SERVER2_THRIFT_RESULTSET_SERIALIZE_IN_TASKS(
        ...
        HIVE_SERVER2_XSRF_FILTER_ENABLED(
        ...
        HIVE_MOVE_FILES_THREAD_COUNT(
                ...
                15,
                new SizeValidator(0L, true, 1024L, true),
                "Number of threads"
        ...
        HIVE_LOAD_DYNAMIC_PARTITIONS_THREAD_COUNT(
        ...
        HIVEOPTLISTBUCKETING(
                "hive.optimize.listbucketing",
                false,
                "Enable list bucketing optimizer. Default value is false so that we disable it by default."),

        // Allow TCP Keep alive socket option for for HiveServer or a maximum timeout for the
        // socket.
        SERVER_READ_SOCKET_TIMEOUT(
        ...
        HIVE_VECTORIZATION_REDUCE_GROUPBY_ENABLED(
                ...
                "This flag should be set to true to enable vectorized mode of the reduce-side GROUP BY query execution.\n"
                        + "The default value is true."),
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_ENABLED(
                ...
                "This flag should be set to true to enable native (i.e. non-pass through) vectorization\n"
                        ...
                        + "The default value is true."),
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_MULTIKEY_ONLY_ENABLED(
                ...
                "This flag should be set to true to restrict use of native vector map join hash tables to\n"
                        ...
                        + "The default value is false."),
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_MINMAX_ENABLED(
                ...
                "This flag should be set to true to enable vector map join hash tables to\n"
                        ...
                        + "The default value is false."),
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_OVERFLOW_REPEATED_THRESHOLD(
        ...
        HIVE_VECTORIZATION_MAPJOIN_NATIVE_FAST_HASHTABLE_ENABLED(
                ...
                "This flag should be set to true to enable use of native fast vector map join hash tables in\n"
                        ...
                        + "The default value is false."),
        HIVE_VECTORIZATION_GROUPBY_CHECKINTERVAL(
        ...
        HIVE_VECTORIZATION_GROUPBY_MAXENTRIES(
                "hive.vectorized.groupby.maxentries",
                1000000,
                "Max number of entries in the vector group by aggregation hashtables. \n"
                        + "Exceeding this will trigger a flush irrelevant of memory pressure condition."),
        HIVE_VECTORIZATION_GROUPBY_FLUSH_PERCENT(
        ...
        HIVE_VECTORIZATION_REDUCESINK_NEW_ENABLED(
                ...
                "This flag should be set to true to enable the new vectorization\n"
                        ...
                        + "The default value is true."),
        HIVE_VECTORIZATION_USE_VECTORIZED_INPUT_FILE_FORMAT(
                ...
                "This flag should be set to true to enable vectorizing with vectorized input file format capable SerDe.\n"
                        + "The default value is true."),
        HIVE_VECTORIZATION_USE_VECTOR_DESERIALIZE(
        ...
        HIVE_TYPE_CHECK_ON_INSERT(
                ...
                true,
                "This property has been extended to control "
        ...
        HIVESTAGEIDREARRANGE(
                ...
                "none",
                new StringSet("none", "idonly", "traverse", "execution"),
                ""),
        ...
        HIVE_SUPPORT_SPECICAL_CHARACTERS_IN_TABLE_NAMES(
        ...
        HIVE_COMPAT(
                "hive.compat",
                HiveCompat.DEFAULT_COMPAT_LEVEL,
        ...
        HIVE_CONVERT_JOIN_BUCKET_MAPJOIN_TEZ(
        ...
        TEZ_DYNAMIC_SEMIJOIN_REDUCTION(
        ...
        TEZ_TASK_SCALE_MEMORY_RESERVE_FRACTION_MIN(
        ...
        LLAP_IO_NONVECTOR_WRAPPER_ENABLED(
        ...
        LLAP_CACHE_ALLOW_SYNTHETIC_FILEID(
        ...
        LLAP_CACHE_ENABLE_ORC_GAP_CACHE(
        ...
        LLAP_IO_ENCODE_VECTOR_SERDE_ASYNC_ENABLED(
        ...
        LLAP_IO_ENCODE_SLICE_ROW_COUNT(
        ...
        LLAP_IO_DECODING_METRICS_PERCENTILE_INTERVALS(
        ...
        LLAP_MANAGEMENT_ACL_DENY(
                "hive.llap.management.acl.blocked", "", "The deny ACL for LLAP daemon management."),
        LLAP_REMOTE_TOKEN_REQUIRES_SIGNING(
        ...
        LLAP_DAEMON_YARN_CONTAINER_MB(
                ...
                "llap.daemon.yarn.container.mb"),
        LLAP_DAEMON_QUEUE_NAME(
        ...
        LLAP_DAEMON_SHUFFLE_DIR_WATCHER_ENABLED(
                "hive.llap.daemon.shuffle.dir.watcher.enabled",
                false,
                "TODO doc",
                "llap.daemon.shuffle.dir-watcher.enabled"),
        ...
        LLAP_DAEMON_VCPUS_PER_INSTANCE(
        ...
        LLAP_DAEMON_NUM_FILE_CLEANER_THREADS(
                "hive.llap.daemon.num.file.cleaner.threads",
                1,
                "Number of file cleaner threads in LLAP.",
                "llap.daemon.num.file.cleaner.threads"),
        LLAP_FILE_CLEANUP_DELAY_SECONDS(
        ...
        LLAP_DAEMON_SERVICE_REFRESH_INTERVAL(
        ...
        LLAP_DAEMON_COMMUNICATOR_NUM_THREADS(
        ...
        LLAP_DAEMON_DOWNLOAD_PERMANENT_FNS(
        ...
        LLAP_TASK_SCHEDULER_NUM_SCHEDULABLE_TASKS_PER_NODE(
                ...
                "llap.task.scheduler.num.schedulable.tasks.per.node"),
        ...
        LLAP_DAEMON_TASK_SCHEDULER_WAIT_QUEUE_SIZE(
                "hive.llap.daemon.task.scheduler.wait.queue.size",
                10,
                "LLAP scheduler maximum queue size.",
                "llap.daemon.task.scheduler.wait.queue.size"),
        LLAP_DAEMON_WAIT_QUEUE_COMPARATOR_CLASS_NAME(
                ...
                "llap.daemon.wait.queue.comparator.class.name"),
        ...
        LLAP_DAEMON_OUTPUT_SERVICE_PORT(
                "hive.llap.daemon.output.service.port", 15003, "LLAP daemon output service port"),
        LLAP_DAEMON_OUTPUT_STREAM_TIMEOUT(
        ...
        SPARK_USE_FILE_SIZE_FOR_MAPJOIN(
        ...
        SPARK_RPC_SERVER_PORT(
                ...
                "",
                "A list of port ranges which can be used by RPC server "
        ...
        HIVE_MERGE_NWAY_JOINS(
                "hive.merge.nway.joins", true, "Merge adjacent joins into a single n-way join"),
        HIVE_LOG_N_RECORDS(
                "hive.log.every.n.records",
                0L,
                new RangeValidator(0L, null),
                "If value is greater than 0 logs in fixed intervals of size n rather than exponentially."),
        HIVE_MSCK_PATH_VALIDATION(
                "hive.msck.path.validation",
                "throw",
                new StringSet("throw", "skip", "ignore"),
                "The approach msck should take with HDFS "
        ...
        HIVE_SERVER2_LLAP_CONCURRENT_QUERIES(
                "hive.server2.llap.concurrent.queries",
                -1,
                "The number of queries allowed in parallel via llap. Negative number implies 'infinite'."),
        HIVE_TEZ_ENABLE_MEMORY_MANAGER(
                "hive.tez.enable.memory.manager", true, "Enable memory manager for tez"),
        HIVE_HASH_TABLE_INFLATION_FACTOR(
        ...
        HIVE_LOG_TRACE_ID(
                ...
                "Log tracing id that can be used by upstream clients for tracking respective logs. "
                        + "Truncated to "
                        + LOG_PREFIX_LENGTH
                        + " characters. Defaults to use auto-generated session id."),

        HIVE_CONF_RESTRICTED_LIST(
        ...
        HIVE_EXEC_INPUT_LISTING_MAX_THREADS(
        ...
        HIVE_BLOBSTORE_OPTIMIZATIONS_ENABLED(
        ...
        private static String findHadoopBinary() {
            ...
            val =
                    (val == null ? File.separator + "usr" : val)
                            + File.separator
                            + "bin"
                            + File.separator
                            + "hadoop";
    ...
    /**
     * Writes the default ConfVars out to a byte array and returns an input stream wrapping that
     * byte array.
     *
     * <p>We need this in order to initialize the ConfVar properties in the underling Configuration
     * object using the addResource(InputStream) method.
     *
     * <p>It is important to use a LoopingByteArrayInputStream because it turns out
     * addResource(InputStream) is broken since Configuration tries to read the entire contents of
     * the same InputStream repeatedly without resetting it. LoopingByteArrayInputStream has special
    ...
    /**
     * check whether spark related property is updated, which includes spark configurations, RSC
     * configurations and yarn configuration in Spark on YARN mode.
     *
     * @param name
     * @return
     */
    ...
    public static long toTime(String value, TimeUnit inputUnit, TimeUnit outUnit) {
        ...
        return outUnit.convert(
                Long.parseLong(parsed[0].trim()), unitFor(parsed[1].trim(), inputUnit));
    }
    ...
    public static String getVar(Configuration conf, ConfVars var) {
        assert (var.valClass == String.class) : var.varname;
        return var.altName != null
                ? conf.get(var.varname, conf.get(var.altName, var.defaultStrVal))
                : conf.get(var.varname, var.defaultStrVal);
    }

    public static String getVarWithoutType(Configuration conf, ConfVars var) {
        return var.altName != null
                ? conf.get(var.varname, conf.get(var.altName, var.defaultExpr))
    ...
    public static String getVar(Configuration conf, ConfVars var, String defaultVal) {
        String ret =
                var.altName != null
                        ? conf.get(var.varname, conf.get(var.altName, defaultVal))
                        : conf.get(var.varname, defaultVal);
        return ret;
    }

    public static String getVar(
            Configuration conf, ConfVars var, EncoderDecoder<String, String> encoderDecoder) {
    ...
    private void initialize(Class<?> cls) {
        ...
        String msUri = this.getVar(ConfVars.METASTOREURIS);
        ...
        if ((this.get("hive.metastore.ds.retry.attempts") != null)
            ...
            l4j.warn(
                    "DEPRECATED: hive.metastore.ds.retry.* no longer has any effect.  "
            ...
            auxJars =
                    StringUtils.join(
                            FileUtils.getJarFilesByPath(
                                    this.get(ConfVars.HIVEAUXJARS.varname), this),
                            ',');
        }
    ...
    /**
     * Default list of modifiable config parameters for sql standard authorization For internal use
     * only.
     */
    ...
    /**
     * Default list of regexes for config parameters that are modifiable with sql standard
    ...
    /**
     * Apply system properties to this object if the property name is defined in ConfVars and the
    ...
    /**
     * Add the HIVE_CONF_RESTRICTED_LIST values to restrictList, including HIVE_CONF_RESTRICTED_LIST
     * itself
     */
    ...
    public static class StrictChecks {
        ...
        private static final String NO_LIMIT_MSG =
                makeMessage("Order by-s without limit", ConfVars.HIVE_STRICT_CHECKS_LARGE_QUERY);
        ...
        private static final String NO_CARTESIAN_MSG =
                makeMessage("Cartesian products", ConfVars.HIVE_STRICT_CHECKS_CARTESIAN);
        private static final String NO_BUCKETING_MSG =
                makeMessage("Load into bucketed tables", ConfVars.HIVE_STRICT_CHECKS_BUCKETING);

        private static String makeMessage(String what, ConfVars setting) {
            return what
                    + " are disabled for safety reasons. If you know what you are doing, please set"
                    + setting.varname
                    + " to false and that "
                    + ConfVars.HIVEMAPREDMODE.varname
                    + " is not"
        ...
        public static String checkNoPartitionFilter(Configuration conf) {
            return isAllowed(conf, ConfVars.HIVE_STRICT_CHECKS_LARGE_QUERY)
                    ? null
                    : NO_PARTITIONLESS_MSG;
        }

        public static String checkTypeSafety(Configuration conf) {
            return isAllowed(conf, ConfVars.HIVE_STRICT_CHECKS_TYPE_SAFETY)
                    ? null
                    : NO_COMPARES_MSG;
        }
